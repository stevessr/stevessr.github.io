---
title: "Linux (Debian 系) 下配置 aria2"
date: 2025-01-05T22:45:00+08:00
draft: false
author: "stevessr"
keywords: ["aria2", "Linux", "Debian", "下载管理", "RPC", "自启动"]
cover: ""
summary: "本文提供在 Debian 系 Linux 系统下安装和配置 aria2 的完整步骤，包括创建和编辑配置文件、设置 RPC、启用自启动服务以及常用优化选项。"
type: "yaml"
tags: ["aria2", "Linux", "配置", "自启动", "RPC"]
categories: ["系统配置", "下载工具"]
---
...
```conf
## 高级设置  ##                                                                         
#是否允许写覆盖Restart download from scratch if the corresponding control file doesn't >
